...
func (s *KubeletServer) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&s.NetworkPluginName, "network_plugin", s.NetworkPluginName, "The name of the network plugin to be invoked for various events in kubelet/pod lifecycle")
}
